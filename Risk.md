...
Safeguard depositors’ money and shareholder value.

Ensure compliance with regulatory requirements (Basel III/IV, RBI, ECB, Fed, etc.).
...
Managed via credit scoring, collateral, provisioning, and diversification.

🔹 Market Risk – Losses due to market fluctuations.

Interest Rate Risk – changes in rates impacting margins.

Foreign Exchange Risk – volatility in currency markets.

Equity/Commodity Risk – exposure to price movements.

🔹 Operational Risk – Failures in processes, people, systems, or external events.

Includes fraud, cyberattacks, IT outages, human errors.
...
Chief Risk Officer (CRO) – oversees enterprise-wide risk.
...
Basel III/IV – capital adequacy, liquidity coverage ratio (LCR), leverage ratio.

Local Regulators – RBI, Fed, ECB, FCA, etc.

AML/KYC laws – global compliance.
